...
const Problem = lazyWithRetry(() => import('./pages/Problem'))
const TestSupabase = lazyWithRetry(() => import('./pages/TestSupabase'))
...
const AdminFilters = lazyWithRetry(() => import('./pages/admin/AdminFilters'))
const AdminHeroSlides = lazyWithRetry(() => import('./pages/admin/AdminHeroSlides'))
