...
import { Home, Store, Heart, ShoppingCart, User, Menu } from "lucide-react"
...
export default function BottomNavigation() {
  ...
  const isActive = (item: any) => {
    if (item.isAction) return mobileMenuOpen;
    const itemPath = item.href?.split("?")[0];
    if (itemPath === "/") return pathname === "/";
    if (itemPath === "/shop") return pathname === "/shop" || pathname.startsWith("/shop/") || pathname.startsWith("/product/");
